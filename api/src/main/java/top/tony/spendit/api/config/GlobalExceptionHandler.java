...
import top.tony.spendit.api.exceptions.*;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<MessageResponse> handleMethodArgumentNotValidException(MethodArgumentNotValidException e) {
        ...
        if (error == null) {
            return ResponseEntity.badRequest().body(MessageResponse.badRequest("Parameter error"));
        }
        return ResponseEntity.badRequest().body(
                MessageResponse.badRequest(String.format("Parameter error: %s - %s",
